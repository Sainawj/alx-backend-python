...
async def measure_runtime() -> float:
    '''Measures the total execution time for running
    async_comprehension 4 times.

    This function asynchronously executes the async_comprehension
    function 4 times
    in parallel using asyncio.gather(), and calculates the
