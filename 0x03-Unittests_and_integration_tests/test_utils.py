#!/usr/bin/env python3
"""Module to test functions in the utils file."""
...
class TestAccessNestedMap(unittest.TestCase):
    ...
    def test_access_nested_map(self, nested_map, path, expected):
        ...
        based on provided nested map and path.
        """
    ...
    def test_access_nested_map_exception(self, nested_map, path, expected):
        ...
        when accessing a missing path in the nested map.
        """
...
class TestGetJson(unittest.TestCase):
    ...
    def test_get_json(self, test_url, test_payload):
        ...
        based on the mocked URL response.
        """
...
class TestMemoize(unittest.TestCase):
    ...
    def test_memoize(self):
        """
        Test that memoize caches the result of a_property, ensuring
        a_method is called only once even if a_property is accessed
        multiple times.
        """
